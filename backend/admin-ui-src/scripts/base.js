...
const state={
  ...
  captureQueue:[],sessionApiUrl:'',sessionAdminKey:'',sessions:[],sessionExpandedIds:new Set(),sessionReviewExpandedIds:new Set(),sessionSelectedIds:new Set(),sessionRecentRerunIds:new Set(),sessionRecentChangedIds:new Set(),sessionLastRerunSummary:'',sessionPageSize:25,sessionPage:1,sessionsAutoLoaded:false,backupsAutoLoaded:false,scarabsAutoLoaded:false,tokensAutoLoaded:false,healthAutoLoaded:false,bulkToolsAutoLoaded:false,
