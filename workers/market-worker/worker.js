...
async function handleRequest(request, env, ctx) {
  ...
  const requiresLeague = type === "EVHistory"
    || type === "PriceHistory"
    || type === "AtlasEVHistory"
    || type === "Scarab"
    || type === "Currency";
  if (requiresLeague && !league) {
    return errorResponse("missing_league", "Missing league query param.", 400, String(type || "market").toLowerCase());
  }
